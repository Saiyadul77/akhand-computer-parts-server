...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.s3wad.mongodb.net/?retryWrites=true&w=majority`;
...
app.listen(port, () => {
    console.log('Akhand Computer parts running', port);
})